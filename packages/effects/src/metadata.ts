...
export const EFFECT_LIST: EffectMetadata[] = [
    ...
    },
    {
        key: "aurora2",
        label: "Aurora (Smooth)",
        description: "Smooth flowing aurora bands with fractal noise and wave distortion",
        defaultColors: ["#22c55e", "#3b82f6", "#8b5cf6", "#06b6d4"],
        scopes: ["background", "button"],
    },
    {
        key: "fractals",
        label: "Fractals",
        description: "Self-similar recursive patterns with cosine palette color cycling",
    ...
    },
    {
        key: "fire",
        label: "Fire & Smoke",
        description: "Volumetric fire with rising smoke and drifting sparks",
        defaultColors: ["#f97316", "#78716c"],
        scopes: ["background", "button"],
    },
    {
        key: "bubbles",
        label: "Soap Bubbles",
        description: "Iridescent floating bubbles with thin-film interference and specular highlights",
